...
/**
 * Given the "source of truth" state for the pagination feature and additional arguments,
 * returns "derived state" values and convenience functions. - For local/client-computed tables only.
 * Performs the actual pagination logic, which is done on the server for server-computed tables.
