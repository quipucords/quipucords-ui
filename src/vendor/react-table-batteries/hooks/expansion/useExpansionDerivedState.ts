...
export interface ExpansionDerivedState<TItem, TColumnKey extends string> {
   ...
   *  - If called without a columnKey, returns whether the entire row or any cell in it is expanded (for both
   *  single-expand and compound-expand)
   */
...
/**
 * Given the "source of truth" state for the expansion feature and additional arguments,
 ...
 * this is not named `useClientExpansionDerivedState` because it is always local/client-computed,
