 ...
 * - Takes "source of truth" state and table-level derived state (derived either on the server or in
 * useClientTableDerivedState) along with API data and additional args.
 ...
 * call this last after calling useTableState and fetching your API data.
 *
