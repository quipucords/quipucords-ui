 ...
 * Given a structured filter values object, returns a string to be stored in the feature's PersistTarget (URL params,
 * localStorage, etc).
 */
...
/**
 * Helper function for useFilterState
 * Given a string retrieved from the feature's PersistTarget (URL params, localStorage, etc),
 * converts it back to the structured filter values object.
 */
