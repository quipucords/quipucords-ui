 ...
 * - Included in the `TableState` object returned by useTableState under the `activeItem` sub-object (combined with
 * args above). - Also included in the `TableBatteries` object returned by useTablePropHelpers and
