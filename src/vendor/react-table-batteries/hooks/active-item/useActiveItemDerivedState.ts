...
/**
 * Given the "source of truth" state for the active item feature and additional arguments,
 ...
 * this is not named `useClientActiveItemDerivedState` because it is always local/client-computed,
