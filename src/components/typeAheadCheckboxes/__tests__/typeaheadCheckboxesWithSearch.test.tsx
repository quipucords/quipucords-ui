...
import { TypeaheadCheckboxesWithSearch } from '../typeaheadCheckboxesWithSearch';
...
describe('TypeaheadCheckboxesWithSearch', () => {
  beforeEach(() => {
  ...
  it('should render a basic component', async () => {
    ...
    const component = await shallowComponent(<TypeaheadCheckboxesWithSearch {...props} />);
  ...
  it('should show "No results found" when search yields no matches', async () => {
    render(<TypeaheadCheckboxesWithSearch credentialType="network" selectedOptions={[]} onChange={jest.fn()} />);
