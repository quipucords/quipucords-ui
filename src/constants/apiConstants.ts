...
const API_RESPONSE_SOURCE_CONNECTION_TASK_ID = 'source_task_id';
const API_RESPONSE_SOURCE_CONNECTION_TASK_STATUS = 'source_task_status';
...
const API_HASHICORP_VAULT_CONFIG_QUERY = 'hashicorpVaultGlobalConfig';
...
const apiTypes = {
  ...
  API_RESPONSE_SOURCE_CONNECTION_TASK_ID,
  API_RESPONSE_SOURCE_CONNECTION_TASK_STATUS,
  ...
  API_HASHICORP_VAULT_CONFIG_QUERY
};
